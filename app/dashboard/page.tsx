...
const PersonalDashboard = memo(({ 
  ...
  <div className="space-y-8">
    {/* Welcome Section */}
    <div className={`${themeColors.cardBg} rounded-2xl ${themeColors.shadow} border ${themeColors.border} p-8 text-center overflow-hidden relative group hover-lift`}>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      <div className={`${themeColors.cardBg} rounded-2xl ${themeColors.shadow} border ${themeColors.border} p-6 hover-lift group overflow-hidden relative`}>
        <div className="absolute -top-12 -right-12 w-32 h-32 rounded-full bg-gradient-to-r from-blue-400 to-purple-400 opacity-10 group-hover:opacity-20 transition-opacity"></div>
        <div className="relative z-10">
          <div className="flex items-center justify-between mb-4">
            <p className={`text-sm ${themeColors.textLight} font-medium`}>Performance Rating</p>
            <div className={`p-3 ${theme.isDayTime ? 'bg-blue-50' : 'bg-blue-900/20'} rounded-xl`}>
              <svg className="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" />
              </svg>
            </div>
          </div>
          <p className={`text-3xl font-bold ${themeColors.text}`}>4.5<span className="text-xl text-gray-500">/5.0</span></p>
          <div className="flex items-center gap-2 mt-3">
            <div className="w-full bg-gray-200 rounded-full h-3 overflow-hidden">
              <div className="bg-gradient-to-r from-yellow-400 to-yellow-600 h-3 rounded-full" style={{ width: '90%' }}></div>
            </div>
      ...
      <div className={`${themeColors.cardBg} rounded-2xl ${themeColors.shadow} border ${themeColors.border} p-6 hover-lift group overflow-hidden relative`}>
        <div className="absolute -top-12 -right-12 w-32 h-32 rounded-full bg-gradient-to-r from-green-400 to-teal-400 opacity-10 group-hover:opacity-20 transition-opacity"></div>
        <div className="relative z-10">
          <div className="flex items-center justify-between mb-4">
            <p className={`text-sm ${themeColors.textLight} font-medium`}>Tasks Completed</p>
            <div className={`p-3 ${theme.isDayTime ? 'bg-green-50' : 'bg-green-900/20'} rounded-xl`}>
          ...
          <div className="flex items-center gap-2 mt-3">
            <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800">↑ +15% from last month</span>
          </div>
        </div>
      </div>

      <div className={`${themeColors.cardBg} rounded-2xl ${themeColors.shadow} border ${themeColors.border} p-6 hover-lift group overflow-hidden relative`}>
        <div className="absolute -top-12 -right-12 w-32 h-32 rounded-full bg-gradient-to-r from-green-400 to-emerald-400 opacity-10 group-hover:opacity-20 transition-opacity"></div>
        <div className="relative z-10">
          <div className="flex items-center justify-between mb-4">
    ...
    {/* My Tasks */}
    <div className={`${themeColors.cardBg} rounded-2xl ${themeColors.shadow} border ${themeColors.border} overflow-hidden`}>
      <div className={`px-6 py-5 border-b ${themeColors.border} bg-gradient-to-r ${themeColors.gradientFrom} ${themeColors.gradientTo}`}>
        <div className="flex items-center justify-between">
          <div>
            <h3 className={`text-lg font-bold ${themeColors.text} flex items-center gap-3`}>
              <span className="w-1 h-6 bg-blue-500 rounded-full"></span>
              My Tasks
            </h3>
            <p className={`text-sm ${themeColors.textLight} mt-1`}>Your current assignments</p>
          </div>
          <button className="px-4 py-2 text-sm bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all transform hover:-translate-y-0.5 shadow-md hover:shadow-lg">
            + New Task
          </button>
        </div>
      </div>
